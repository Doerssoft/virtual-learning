...
function loadMusic(indexNumb){
   mainVideo.src = `../../../media/${allVideos[indexNumb - 1].src}`;
   videoTitle.innerHTML = `${allVideos[indexNumb - 1].name}`
...
for(let i = 0; i < allVideos.length; i++){
   ...
   let liTag = `<li li-index="${i + 1}">
      ...
      <video class="${allVideos[i].id}" src="../../../media/${allVideos[i].src}" style="display: none;" title="${allVideos[i].name}"></video>
